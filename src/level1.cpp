...
Level1::Level1(int width, int height, const char* effect_fragment_shader):
    width(width),
    height(height),
    start(false),
    collision(false),
...
void Level1::processInput(float dt, int keys[])
{
...
void Level1::generatePipes(int n)
{
    srand(time(0));
    pipe_position=1200;
    float gap=350;
